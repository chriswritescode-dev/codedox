...
def generate_markdown_report(results: Dict[str, Any]) -> None:
    ...
    if 'recommendations' in results:
        ...
        report.append(f"3. **Monitor Closely**: Track error rates and P95 latencies when scaling\n")
        report.append(f"4. **Regular Testing**: Re-test when changing LLM models or infrastructure\n")
